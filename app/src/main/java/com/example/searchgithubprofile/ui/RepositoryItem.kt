...
import com.example.searchgithubprofile.viewmodel.DateUtil
import com.example.searchgithubprofile.viewmodel.SearchViewModel

@Composable
fun RepositoryItem(
    repository: SearchItem.Repository,
    onClick: (SearchItem.Repository) -> Unit
) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Row(
            ...
            Text(
                text = repository.name ?: "No name available",
